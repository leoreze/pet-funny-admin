...
(function () {
  ...
  // ===== API HELPERS =====
    // PATCH: API helpers extraídos para pf_api.js - 2025-12-22
  // As funções globais apiGet/apiPost/apiPut/apiDelete são fornecidas por pf_api.js
